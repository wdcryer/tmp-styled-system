...
test('parser configs can be composed manually', function () {
  ...
  var layout = (0, _core.system)({
    width: true,
    height: true
  });
  var composed = (0, _core.system)(_extends({}, color.config, {}, layout.config));
  var style = composed({
    color: 'tomato',
...
test('sorts media queries when responsive object values are used', function () {
  ...
  expect(Object.keys(styles)).toEqual(['@media screen and (min-width: 32em)', '@media screen and (min-width: 40em)', '@media screen and (min-width: 64em)', '@media screen and (min-width: 128em)', 'padding']);
});
test('transforms values', function () {
  var parser = (0, _core.system)({
    margin: {
      property: 'margin',
      transform: function transform(n, scale, props) {
