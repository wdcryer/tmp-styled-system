...
test('returns a pixel font-size', function () {
  var a = (0, _styledSystem.fontSize)({
    fontSize: 48
  });
  expect(a).toEqual({
    fontSize: 48
...
test('size returns width and height', function () {
  var styles = (0, _styledSystem.size)({
    size: 4
  });
...
test('gridRowGap returns a scalar style', function () {
  var a = (0, _styledSystem.gridRowGap)({
    theme: {
      space: [0, 2, 4, 8]
    },
    gridRowGap: 3
...
test('gridColumnGap returns a scalar style', function () {
  var a = (0, _styledSystem.gridColumnGap)({
    theme: {
      space: [0, 2, 4, 8]
    },
    gridColumnGap: 3
...
test('compose maintains media query order', function () {
  var parser = (0, _styledSystem.compose)(_styledSystem.color, _styledSystem.layout);
  var a = parser({
