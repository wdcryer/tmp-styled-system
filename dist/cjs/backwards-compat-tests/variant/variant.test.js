...
test('variant returns style objects from theme', function () {
  var buttons = (0, _variant.variant)({
    key: 'buttons'
  });
  var a = buttons({
    theme: {
...
test('variant can be composed', function () {
  var system = (0, _core.compose)((0, _variant.variant)({
    key: 'typography'
  }), fontSize, color);
  var result = system({
    theme: {
...
describe('component variant', function () {
  ...
  test('can be composed with other style props', function () {
    var parser = (0, _core.compose)((0, _variant.variant)({
      variants: {
        tomato: {
          color: 'tomato',
          fontSize: 20,
